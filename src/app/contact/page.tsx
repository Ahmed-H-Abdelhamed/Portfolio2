...
export default function ContactPage() {
  ...
  const FacebookIcon = () => (
    ...
    >
      <path
        fillRule="evenodd"
        d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-极3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"
        clipRule="evenodd"
      />
    </svg>
  );
  ...
  const LinkedInIcon = () => (
    ...
    >
      <path
        fillRule="evenodd"
        d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-极3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"
        clipRule="evenodd"
      />
    </svg>
  );
    ...
    <main className="min-h-screen p-4 md:p-8 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex flex-col items-center justify-center">
      <div className="max-w-6xl w-full mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4极xl md:text-5xl font-bold mb-4 text-gray-800 dark:text-gray-100">
            Get in Touch
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Have a project in mind or work or just want to say hello? I&apos;d love to hear from you.
          </p>
        </div>
                ...
                <>
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="currentColor"
                      d="M4 12a8 8 0 018-8极V0C5.373 0 0 5.极373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"
                    ></path>
                  </svg>
                  Sending...
                </>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-2xl shadow-xl w-full flex flex-col justify-center">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">ahmed.abdelhamed5354@gmail.com</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">+201122801439</p>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="flex gap-3">
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/ahmed.hesham.abdel.hamed"
                ...
                {/* Instagram */}
                <a
                  href="#https://www.instagram.com/ahmed_hesham902/"
                  className="bg-gray-100 dark:bg-gray-700 p-3 rounded-full hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors"
                >
                  <svg
                    className="h-5 w-5 text-gray-600 dark:text-gray-300"
                    viewBox="0 0 24 24"
                ...
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com/in/ahmed-hesham-abdelhamed/"
                  className="bg-gray-100 dark:bg-gray-700 p-3 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                >
                  <svg
                    className="h-5 w-5 text-gray-600 dark:text-gray-300"
