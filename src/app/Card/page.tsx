  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4 py-8 w-full relative overflow-hidden bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 ">
      ...
      >
        ...
        <motion.div
          whileHover={{ scale: 1.24, rotate: 2 }}
          transition={{ type: 'spring', stiffness: 300 }}
          className="relative w-46 h-46 group"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full blur-md opacity-30 group-hover:opacity-50 transition-opacity"></div>
            <div className="relative w-46 h-46 rounded-full overflow-hidden border-4 border-white dark:border-gray-800">
              <Image
                src="/Hesham.jpg"
                alt="Profile Picture of Hesham"
                fill
        ...
        <div className="text-center space-y-2">
          ...
          >
            I love building modern, responsive, and user-friendly Dashboards. Currently focusing on{' '}
            <span className="font-semibold text-[#6B76DD]">Data analysis</span>,{' '}
            <span className="font-semibold text-[#6B76DD]">Power BI</span>,{' '}
            <span className="font-semibold text-[#6B76DD]">Tableau</span>,{' '}
            <span className="font-semibold text-[#6B76DD]">Python</span>, and{' '}
            <span className="font-semibold text-[#6B76DD]">SQL</span>.
          </motion.p>
        </div>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            href="https://github.com/Ahmed-H-Abdelhamed"
            target="_blank"
          ...
          <motion.a
            ...
            onClick={(e) => {
              e.preventDefault();
              const gmailLink =
                'https://mail.google.com/mail/u/0/?fs=1&to=ahmed.abdelhamed5354@gmail.com&tf=cm';
              const mailtoLink = 'mailto:ahmed.abdelhamed5354@gmail.com';
            ...
            href="mailto:ahmed.abdelhamed5354@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
