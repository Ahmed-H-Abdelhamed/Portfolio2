  ...
  const projects = [
    {
      ...
      description:
        'An interactive data visualization dashboard in Power BI exploring the Titanic dataset, including passenger demographics, survival rates, and voyage details.',
      image: '/Titanic_Dashboard.png', // Placeholder: replace with actual image path
      videoEmbed: '', // If you have a video embed, add here
      github: '', // Add if applicable
      live: 'https://app.powerbi.com/groups/me/reports/371607db-f294-4224-927f-bc4336a40f0c?pbi_source=desktop', // Add live demo link if available
    },
    {
      name: 'Layoffs Dashboard',
      description:
        'A Power BI dashboard tracking layoffs across industries, analyzing affected sectors, employee counts, and regional trends with interactive charts.',
      image: '/Layoffs_Dashboard.png', // Placeholder: replace with actual image path
      videoEmbed: '', // If you have a video embed, add here
      github: '', // Add if applicable
      live: 'https://app.powerbi.com/groups/me/reports/2ecf6e68-10d0-4297-95cc-718f65abde9e/78da2662da3e5750abdc?experience=power-bi', // Add live demo link if available
    },
    {
      name: 'Online courses Dashboard',
      description:
        'A Power BI dashboard monitoring online course enrollments, student progress, course completion rates, and instructor performance.',
      image: '/Online_courses_Dashboard.png', // Placeholder: replace with actual image path
      videoEmbed: '', // If you have a video embed, add here
      github: '', // Add if applicable
      live: 'https://app.powerbi.com/groups/me/reports/ea8f37a8-3e3d-45e4-a216-baa9cb6b24c5/530f57ced298726787a7?experience=power-bi', // Add live demo link if available
    },
    {
      name: 'Canda Sales Dashboard',
      description:
        'A Power BI dashboard detailing sales performance across Canada, highlighting regional revenue, product distribution, and sales growth trends.',
      image: '/Canda_Sales_Dashboard.png', // Placeholder: replace with actual image path
      videoEmbed: '', // If you have a video embed, add here
      github: '', // Add if applicable
      live: 'https://app.powerbi.com/groups/me/reports/d02a434b-7279-4b09-900a-080abe6b056f/7f45677cfb8324b76502?experience=power-bi', // Add live demo link if available
    },
  ];
      ...
      <main className="min-h-screen w-full py-12 px-12 md:px-8 bg-gradient-to-br from-gray-900 to-gray-800 dark:from-gray-900 dark:to-gray-800 ">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-md mt-3 max-w-2xl mx-auto text-gray-700 dark:text-gray-300">
              Selected projects highlighting analysis, dashboards, and business impact.
            </p>
          </motion.div>
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="flex gap-3 mt-auto justify-center items-center">
                    ...
                    {project.live && (
                      ...
                      >
                        <FaExternalLinkAlt /> Power BI Server
                      </motion.a>
                    )}
                  </div>
                </div>
